...
| 20 | [`docs/19-devops-practice/`](docs/19-devops-practice/00-why-devops.md) | An 11-part series turning [`devops-practice-plan.md`](plans/devops-practice-plan.md) into practice: Terraform (proving the loop, then state/import/module), Ansible (roles, idempotency, Molecule), CI/CD gaps, Docker, k3s + Vault injector, observability (Prometheus/Grafana/Loki/Alertmanager), GitOps (ArgoCD), and an Azure stretch (offsite backup sync, a Function reading Vault through Tailscale Funnel, Terraform against a second provider). Each doc is what I built, why, what broke, how I found it, how I recovered, same as every doc above |
