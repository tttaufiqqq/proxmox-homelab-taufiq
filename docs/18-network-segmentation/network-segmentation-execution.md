...
**Author:** Taufiq
**Date:** 24 July 2026
**Scope:** Turning `homelab-network-segmentation-execution-plan.md` from a design doc into a running network — OPNsense install, per-VLAN DHCP, firewall rules, and every real thing that broke along the way.
